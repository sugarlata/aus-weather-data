...
from .models import IntensityArrays, DiscreteCells


def get_intensity_arrays(
    png_data: bytes, cell_size_threshold: int = 35
) -> IntensityArrays:
...
def storm_cell_identification_algorithm(
    ...
    return DiscreteCells(discrete_labels, discrete_centroids)
